...
class SettingRepository {
  ...
  ///
  Future<ApiResponse> add(SettingRequest data) async {
    try {
  ...
  ///
  Future<ApiResponse> update(SettingRequest data) async {
    try {
  ...
  Future<ApiResponse> delete(String id) async {
    try {
      final response = await dioClient!.delete('/settings/$id');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
