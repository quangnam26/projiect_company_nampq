...
class UpdateAccountPage extends GetView<UpdateAccountController> {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                                ...
                                child: ClipRRect(
                                  ...
                                  child: IZIImage(
                                    IZIValidate.nullOrEmpty(controller.avatar)
                                        ? IZIValidate.nullOrEmpty(controller.currentUser)
                                            ? ''
                        ...
                        Text(
                          IZIValidate.nullOrEmpty(controller.currentUser) ? '' : controller.currentUser.fullName ?? '',
                          style: TextStyle(
  ...
  Widget nameInput() {
    return IZIInput(
      ...
      initValue: IZIValidate.nullOrEmpty(controller.currentUser) ? '' : controller.currentUser.fullName ?? '',
    );
  }
  ...
  Widget birthDay() {
    return IZIInput(
      ...
      initValue: IZIValidate.nullOrEmpty(controller.currentUser)
          ? ''
          : IZIValidate.nullOrEmpty(controller.currentUser.dateOfBirth)
              ? ''
              : IZIDate.formatDate(DateTime.fromMillisecondsSinceEpoch(controller.currentUser.dateOfBirth!)),
    );
  }
  ...
  Widget phonInput() {
    return IZIInput(
      ...
      initValue: IZIValidate.nullOrEmpty(controller.currentUser) ? '' : controller.currentUser.phone ?? '',
    );
  }
