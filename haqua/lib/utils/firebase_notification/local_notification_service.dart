...
import 'package:template/utils/firebase_notification/listen_notification.dart';
...
class LocalNotificationService {
  ...
  Future<void> init() async {
    ...
    final initializationSettingsIOS = IOSInitializationSettings(onDidReceiveLocalNotification: (int? id, String? title, String? body, String? payload) async {
  ...
  Future<void> scheduleNotification(
    ...
    final androidPlatformChannelSpecifics = AndroidNotificationDetails(androidChannelId, androidChannelName, channelDescription: androidChannelDescription, vibrationPattern: vibrationPattern, enableLights: enableLights!, enableVibration: enableVibration, icon: icon, sound: sound, playSound: playSound!, channelShowBadge: channelShowBadge!, color: color, ledColor: ledColor, ledOnMs: ledOnMs, ledOffMs: ledOffMs);
    const iOSPlatformChannelSpecifics = IOSNotificationDetails(sound: 'slow_spring_board.aiff');
    final platformChannelSpecifics = NotificationDetails(android: androidPlatformChannelSpecifics, iOS: iOSPlatformChannelSpecifics);
    // ignore: deprecated_member_use
    await flutterLocalNotificationsPlugin!.schedule(id, title, body, scheduledDate, platformChannelSpecifics, payload: payload);
  }

  Future<void> repeatNotification(int id, String title, String body, RepeatInterval repeatInterval, String androidChannelId, String androidChannelName, String androidChannelDescription, {String? payload}) async {
    final androidPlatformChannelSpecifics = AndroidNotificationDetails(
      androidChannelId,
      androidChannelName,
      channelDescription: androidChannelDescription,
  ...
  Future<void> checkPendingNotificationRequests(BuildContext context) async {
    ...
    for (final pendingNotificationRequest in pendingNotificationRequests) {
      debugPrint('pending notification: [id: ${pendingNotificationRequest.id}, title: ${pendingNotificationRequest.title}, body: ${pendingNotificationRequest.body}, payload: ${pendingNotificationRequest.payload}]');
    }
  ...
  Future<void> onDidReceiveLocalNotification(BuildContext context, int id, String? title, String? body, String? payload) async {
