                  ...
                  Expanded(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          Text(
                            controller.splashs[controller.currentIndex]['title']
                                .toString(),
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              fontWeight: FontWeight.w600,
                          ...
                          descriptionHighlight(
                              data: controller.splashs[controller.currentIndex]
                                      ['description']
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ...List.generate(
                                ...
                                (val) => Container(
                                  width: controller.currentIndex == val
                                      ? IZIDimensions.ONE_UNIT_SIZE * 50
                                      : IZIDimensions.ONE_UNIT_SIZE * 15,
                                  height: controller.currentIndex == val
                                      ? IZIDimensions.ONE_UNIT_SIZE * 15
                                      : IZIDimensions.ONE_UNIT_SIZE * 15,
                                  margin: EdgeInsets.symmetric(
                                  ...
                                  decoration: BoxDecoration(
                                    shape: controller.currentIndex == val
                                        ? BoxShape.rectangle
                                        : BoxShape.circle,
                                    borderRadius: controller.currentIndex == val
                                        ? BorderRadius.circular(10)
                                        : null,
                                    color: controller.currentIndex == val
              ...
              (index) {
                return TextSpan(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: IZIDimensions.FONT_SIZE_H6 * 0.85,
                    color: data[index]['highlight'].toString() == '1'
                        ? ColorResources.PRIMARY_3
                        : ColorResources.NEUTRALS_3,
                  ),
                );
              },
            )
