...
void main() {
  testWidgets("test multiple selection simple SimpleGroupedCheckbox", (tester) async {
    ...
    await tester.pump();
    final CheckboxListTile cb = tester.widget(find.byType(CheckboxListTile).first) as CheckboxListTile;
    expect(cb.value, true);
    await tester.tap(find.byType(CheckboxListTile).at(1));
    await tester.pump(const Duration(seconds: 5));

    final cb2 = tester.widget(find.byType(CheckboxListTile).at(1)) as CheckboxListTile;
  ...
  testWidgets("test pre-selection for single selection", (tester) async {
    final GroupController controller = GroupController(initSelectedItem: [2]);
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
        body: SimpleGroupedCheckbox<int>(
          controller: controller,
  ...
  testWidgets("test helperGroupTitle : false  simple SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController(isMultipleSelection: true, initSelectedItem: []);
    final listValues = List.generate(5, (index) => index);
  ...
  testWidgets("test helperGroupTitle : true simple SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController(
      isMultipleSelection: true,
      initSelectedItem: [],
    );
  ...
  testWidgets("test select all in multiple selection  SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController(isMultipleSelection: true, initSelectedItem: [1, 2]);
    ...
    await tester.pump();
    final controllerValues = List.from(controller.selectedItem as Iterable);
    controllerValues.sort();
    expect(controllerValues, values);
  });

  testWidgets("test select some values in multiple selection  SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController(isMultipleSelection: true, initSelectedItem: [1, 2]);
    final values = List.generate(10, (index) => index);
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
  ...
  testWidgets("test deselect some values in multiple selection  SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController(isMultipleSelection: true, initSelectedItem: [1, 2]);
    final values = List.generate(10, (index) => index);
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
  ...
  testWidgets("test deselect all in multiple selection  SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController(isMultipleSelection: true, initSelectedItem: [1, 2]);
    final values = List.generate(10, (index) => index);
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
  ...
  testWidgets("test deselect all in one selection  SimpleGroupedCheckbox", (tester) async {
    final GroupController controller = GroupController();
    final values = List.generate(10, (index) => index);
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
