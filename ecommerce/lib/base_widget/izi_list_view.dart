  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          Container(
            margin: marginLabel ?? const EdgeInsets.all(0),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                if (!IZIValidate.nullOrEmpty(labelWidget))
                  labelWidget!
                else if (!IZIValidate.nullOrEmpty(label))
                  IZIText(
                    text: label.toString(),
                    style: TextStyle(
          ...
          SizedBox(
            ...
            height: scrollDirection == Axis.horizontal
                ? height ??
                    IZIDimensions.ONE_UNIT_SIZE * 250 + marginLabel!.vertical
                : null,
