...
class TransactionCard extends StatelessWidget {
  ...
  Widget getStatusMoney(IZIStatusMoney statusPrice) {
    if (statusPrice == IZIStatusMoney.DRAW &&
        !IZIValidate.nullOrEmpty(row2Left)) {
      return IZIText(
        text: IZIStatus.SUCCESS == status &&
                statusPayment == IZIStatusPayment.DONE
            ? "- ${row2Left.toString()}VNĐ"
            : "${row2Left.toString()}VNĐ",
        style: TextStyle(
    ...
    } else if (statusPrice == IZIStatusMoney.RECHARGE &&
        !IZIValidate.nullOrEmpty(row2Left)) {
      return IZIText(
        text: IZIStatus.SUCCESS == status &&
                statusPayment == IZIStatusPayment.DONE
    ...
    } else if (statusPrice == IZIStatusMoney.PLUS &&
        !IZIValidate.nullOrEmpty(row2Left)) {
      return IZIText(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            // border: Border.all(width: 0.25, color: const Color(0xffEAEAEA)),
