...
class NotificationProvider {
  NotificationRepository? repository = GetIt.I.get<NotificationRepository>();
  ...
  ///
  Future<void> all({
    required Function(List<NotificationResponse> address) onSuccess,
  ...
  ///
  /// Get paginate Notifications "page": 1, "limit": 10
  ///
  ...
  Future<void> find({
    required String id,
    required Function(NotificationResponse address) onSuccess,
    required Function(dynamic error) onError,
  }) async {
