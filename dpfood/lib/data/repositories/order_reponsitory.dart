...
class OrderRepository {
  ...
  /// Find bang-bang-cap by id
  ///
  Future<ApiResponse> countTheProduct(String id) async {
    try {
      final String uri = '/orders/count-product/$id';
      final response = await dioClient!.get(uri);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
  ...
  /// Find bang-bang-cap by id
  ///
  Future<ApiResponse> countTheProductsOfStore(String id) async {
    try {
      final String uri = '/orders/count-product-of-shop/$id';
      final response = await dioClient!.get(uri);
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
