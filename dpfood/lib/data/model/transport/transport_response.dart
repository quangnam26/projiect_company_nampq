...
class TransportResponse {
  ...
  factory TransportResponse.fromMap(Map<String, dynamic> map) {
    ...
    return TransportResponse(
      ...
      unitType: map['unitType'] != null ? IZINumber.parseInt(map['unitType']) : 0,
      ...
      netWeight: map['netWeight'] != null ? IZINumber.parseInt(map['netWeight']) : null,
      maxNetWeight: map['maxNetWeight'] != null ? IZINumber.parseInt(map['maxNetWeight']) : null,
