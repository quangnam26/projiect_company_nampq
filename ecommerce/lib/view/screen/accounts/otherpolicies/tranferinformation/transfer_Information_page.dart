...
class TransferInformationPage extends GetView<TransformationController> {
  @override
  Widget build(BuildContext context) {
    return IZIScreen(
      ...
      body: GetBuilder(
        init: TransferInformationController(),
        builder: (TransferInformationController controller) {
