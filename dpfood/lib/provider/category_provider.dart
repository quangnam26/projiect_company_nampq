...
class CategoryProvider {
  CategoryRepository? repository = GetIt.I.get<CategoryRepository>();
  ...
  ///
  Future<void> all({
    required Function(List<CategoryResponse> categorys) onSuccess,
  ...
  Future<void> find({
    required String id,
    required Function(CategoryResponse category) onSuccess,
    required Function(dynamic error) onError,
  }) async {
