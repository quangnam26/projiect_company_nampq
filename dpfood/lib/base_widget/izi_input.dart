...
class _IZIInputState extends State<IZIInput> {
              ...
              Container(
                ...
                child: CupertinoDatePicker(
                  ...
                  onDateTimeChanged: (value) {
                    if (widget.isTimePicker!) {
                      getController(widget.type).text = "${value.hour < 10 ? "0${value.hour}" : value.hour}:${value.minute < 10 ? "0${value.minute}" : value.minute}"; //IZIDate.formatDate(value, format: 'hh:mm a');
              ...
              GestureDetector(
                onTap: () {
                  ...
                  if (widget.isTimePicker! && IZIValidate.nullOrEmpty(value)) {
                    ...
                    getController(widget.type).text = "${now.hour < 10 ? "0${now.hour}" : now.hour}:${now.minute < 10 ? "0${now.minute}" : now.minute}";
                  } else {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isResfreshForm == true) {
      if (widget.type == IZIInputType.NUMBER || widget.type == IZIInputType.PRICE || widget.type == IZIInputType.DOUBLE) {
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                      ...
                      focusNode: focusNode,
                      // inputFormatters: widget.type == IZIInputType.NUMBER ? [
