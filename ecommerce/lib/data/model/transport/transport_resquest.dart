...
class TransportRequest {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      if(!IZIValidate.nullOrEmpty(unitType))'unitType': unitType,
  ...
  factory TransportRequest.fromMap(Map<String, dynamic> map) {
    return TransportRequest(
      ...
      unitType: map['unitType'] != null
          ? IZINumber.parseInt(map['unitType'])
          : null,
      ...
      netWeight: map['netWeight'] != null
          ? IZINumber.parseInt(map['netWeight'])
          : null,
      maxNetWeight: map['maxNetWeight'] != null
          ? IZINumber.parseInt(map['maxNetWeight'])
          : null,
