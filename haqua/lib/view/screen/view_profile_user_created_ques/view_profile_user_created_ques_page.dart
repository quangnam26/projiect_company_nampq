...
class ViewProfileUserCreatedQuesPage extends GetView {
  @override
  Widget build(BuildContext context) {
    return IZIScreen(
      ...
      appBar: IZIAppBar(
        title: "title_app_bar_detail_1".tr,
      ),
      body: GetBuilder(
        init: ViewProfileUserCreatedQuesController(),
        builder: (ViewProfileUserCreatedQuesController controller) {
  ...
  /// Avatar Profile.
  ///
  Widget _avatarProfile(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Stack(
          children: [
            SizedBox(
              width: IZIDimensions.iziSize.width,
                        ...
                        child: Center(
                          child: ClipRRect(
                              ...
                              child: Obx(() {
                                return IZIImage(
                                  controller.userResponse.value.myAlbum![index].toString(),
                                  width: controller.currentIndex.value == index ? IZIDimensions.iziSize.width * .40 : IZIDimensions.iziSize.width * .36,
                                  height: controller.currentIndex.value == index ? IZIDimensions.iziSize.width * .27 : IZIDimensions.iziSize.width * .23,
                                );
                              })),
                        ),
                      ),
  ...
  /// Rated.
  ///
  Widget _rated(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Column(
          children: [
            Container(
              margin: EdgeInsets.only(
              ...
              child: Row(
                ...
                children: [
                  RatingBar.builder(
                    ignoreGestures: true,
                    initialRating: controller.userResponse.value.statisticReview!.totalRating == 0 || controller.userResponse.value.statisticReview!.countRating == 0 ? 0 : controller.userResponse.value.statisticReview!.totalRating! / controller.userResponse.value.statisticReview!.countRating!,
                    minRating: 1,
                  ...
                  Text(
                    controller.userResponse.value.statisticReview!.totalRating == 0 || controller.userResponse.value.statisticReview!.countRating == 0 ? '0' : (controller.userResponse.value.statisticReview!.totalRating! / controller.userResponse.value.statisticReview!.countRating!).toStringAsPrecision(2),
                    style: TextStyle(
                      fontSize: IZIDimensions.FONT_SIZE_H6 * .9,
                      color: ColorResources.BLACK,
                      fontWeight: FontWeight.w600,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            (controller.userResponse.value.statisticReview!.totalReputation != 0 && controller.userResponse.value.statisticReview!.countReputation != 0) ? (controller.userResponse.value.statisticReview!.totalReputation! / controller.userResponse.value.statisticReview!.countReputation!).toStringAsFixed(0) : '0',
                            style: TextStyle(
                              fontSize: IZIDimensions.FONT_SIZE_H6 * .9,
                              color: ColorResources.BLACK,
                              fontWeight: FontWeight.w600,
  ...
  /// Detail Info.
  ///
  Widget _detailInfor(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            //Time
  ...
  /// Experience.
  ///
  Widget _experience(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
  ...
  /// Comment.
  ///
  Widget _comment(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
  ...
  /// Images.
  ///
  Widget _images(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
  ...
  /// Certificates.
  ///
  Widget _certificates(ViewProfileUserCreatedQuesController controller) {
    return Obx(() => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Container(
