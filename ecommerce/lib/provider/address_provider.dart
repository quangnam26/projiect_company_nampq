...
class AddressProvider {
  ...
  ///
  Future<void> all({
    required Function(List<AddressResponse> addressses) onSuccess,
  ...
  Future<void> add({
    ...
    required Function(AddressRequest addressRequest) onSuccess,
    required Function(dynamic error) onError,
  }) async {
  ...
  Future<void> update({
    required AddressRequest data,
    required String id,
    required Function(AddressRequest category) onSuccess,
    required Function(dynamic error) onError,
  }) async {
  ...
  Future<void> paginate({
    ...
    required Function(List<AddressRequest> addresses) onSuccess,
    required Function(dynamic error) onError,
  }) async {
  ...
  Future<void> find({
    required String id,
    required Function(AddressResponse addresses) onSuccess,
    required Function(dynamic error) onError,
  }) async {
