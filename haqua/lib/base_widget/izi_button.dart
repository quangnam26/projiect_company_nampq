...
class IZIButton extends StatelessWidget {
  const IZIButton({
    ...
    this.colorBG = ColorResources.PRIMARY_APP,
    this.colorIcon,
    this.colorText,
    this.imageUrlIcon,
    this.withBorder,
        ...
        decoration: BoxDecoration(
          ...
          border: type == IZIButtonType.DEFAULT
              ...
              : Border.all(
                  ...
                  width: withBorder ?? IZIDimensions.ONE_UNIT_SIZE * 1.5,
                ),
            ...
            if (!IZIValidate.nullOrEmpty(imageUrlIcon))
              ClipOval(
                child: IZIImage(
                  ...
                  width: IZIDimensions.ONE_UNIT_SIZE * 43,
                  height: IZIDimensions.ONE_UNIT_SIZE * 43,
                ),
              ),
            if (icon != null)
              Icon(
            ...
            if (label != null)
              Flexible(
                child: Text(
                  " $label",
                  style: TextStyle(
                    fontSize: fontSizedLabel ?? IZIDimensions.FONT_SIZE_H6 * .9,
