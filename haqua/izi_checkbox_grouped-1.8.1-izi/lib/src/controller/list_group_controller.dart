...
import 'package:izi_izi_checkbox_grouped/src/controller/base_controller.dart';
...
class ListGroupController implements BaseListController {
  ...
  Future<List<dynamic>> selectedItemsByGroupIndex(int index) async => await _state.getValuesByIndex(index);
